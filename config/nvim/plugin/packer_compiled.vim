...
_G.packer_plugins = {
  ...
  ["nvim-compe"] = {
    ...
    config = { "\27LJ\2\nÀ\1\0\0\4\0\6\0\t6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\3\0005\3\4\0=\3\5\2B\0\2\1K\0\1\0\vsource\1\0\5\vbuffer\2\nvsnip\1\rnvim_lua\2\rnvim_lsp\2\tpath\2\1\0\6\14preselect\valways\15min_length\3\1\18documentation\2\17autocomplete\2\fenabled\2\ndebug\1\nsetup\ncompe\frequire\0" },
    loaded = false,
    needs_bufread = false,
    path = "/Users/annguyen/.local/share/nvim/site/pack/packer/opt/nvim-compe"
  },
  ["nvim-lspconfig"] = {
    config = { "\27LJ\2\nŒ\t\0\0\f\0\15\0\0296\0\0\0'\2\1\0B\0\2\0029\1\2\0'\3\3\0'\4\4\0'\5\5\0B\1\4\0016\1\0\0'\3\6\0B\1\2\0025\2\a\0006\3\b\0\18\5\2\0B\3\2\4X\6\6€8\b\a\0019\b\t\b5\n\n\0006\v\v\0=\v\v\nB\b\2\1E\6\3\3R\6ø6\3\f\0009\3\r\3'\5\14\0B\3\2\1K\0\1\0ï\6 \n\t\t\" Show diagnostic popup on cursor hold\n\t\tautocmd CursorHold * lua vim.lsp.diagnostic.show_line_diagnostics()\n\t\tnnoremap <silent> g[ <cmd>lua vim.lsp.diagnostic.goto_prev()<CR>\n\t\tnnoremap <silent> g] <cmd>lua vim.lsp.diagnostic.goto_next()<CR>\n\t\t\" Code navigation shortcuts\n\t\tnnoremap <silent> <c-]> <cmd>lua vim.lsp.buf.definition()<CR>\n\t\tnnoremap <silent> K     <cmd>lua vim.lsp.buf.hover()<CR>\n\t\tnnoremap <silent> gD    <cmd>lua vim.lsp.buf.implementation()<CR>\n\t\tnnoremap <silent> <c-k> <cmd>lua vim.lsp.buf.signature_help()<CR>\n\t\tnnoremap <silent> 1gD   <cmd>lua vim.lsp.buf.type_definition()<CR>\n\t\tnnoremap <silent> gr    <cmd>lua vim.lsp.buf.references()<CR>\n\t\tnnoremap <silent> g0    <cmd>lua vim.lsp.buf.document_symbol()<CR>\n\t\tnnoremap <silent> gW    <cmd>lua vim.lsp.buf.workspace_symbol()<CR>\n\t\tnnoremap <silent> gd    <cmd>lua vim.lsp.buf.declaration()<CR>\n\t\bcmd\bvim\14on_attach\1\0\0\nsetup\vipairs\1\6\0\0\vclangd\18rust_analyzer\fpyright\rtsserver\vsvelte\14lspconfig+<cmd>lua vim.lsp.buf.code_action()<CR>\15<leader>ga\6n\bmap\fp/utils\frequire\0" },
    loaded = true,
  ...
  ["vim-airline"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/Users/annguyen/.local/share/nvim/site/pack/packer/opt/vim-airline"
  },
  ["vim-airline-themes"] = {
    loaded = true,
    path = "/Users/annguyen/.local/share/nvim/site/pack/packer/start/vim-airline-themes"
  },
  ["vim-eunuch"] = {
    loaded = true,
...
try_loadstring("\27LJ\2\n7\0\0\2\0\4\0\0056\0\0\0009\0\1\0'\1\3\0=\1\2\0K\0\1\0\fmolokai\18airline_theme\6g\bvim\0", "setup", "vim-airline")
...
try_loadstring("\27LJ\2\nŒ\t\0\0\f\0\15\0\0296\0\0\0'\2\1\0B\0\2\0029\1\2\0'\3\3\0'\4\4\0'\5\5\0B\1\4\0016\1\0\0'\3\6\0B\1\2\0025\2\a\0006\3\b\0\18\5\2\0B\3\2\4X\6\6€8\b\a\0019\b\t\b5\n\n\0006\v\v\0=\v\v\nB\b\2\1E\6\3\3R\6ø6\3\f\0009\3\r\3'\5\14\0B\3\2\1K\0\1\0ï\6 \n\t\t\" Show diagnostic popup on cursor hold\n\t\tautocmd CursorHold * lua vim.lsp.diagnostic.show_line_diagnostics()\n\t\tnnoremap <silent> g[ <cmd>lua vim.lsp.diagnostic.goto_prev()<CR>\n\t\tnnoremap <silent> g] <cmd>lua vim.lsp.diagnostic.goto_next()<CR>\n\t\t\" Code navigation shortcuts\n\t\tnnoremap <silent> <c-]> <cmd>lua vim.lsp.buf.definition()<CR>\n\t\tnnoremap <silent> K     <cmd>lua vim.lsp.buf.hover()<CR>\n\t\tnnoremap <silent> gD    <cmd>lua vim.lsp.buf.implementation()<CR>\n\t\tnnoremap <silent> <c-k> <cmd>lua vim.lsp.buf.signature_help()<CR>\n\t\tnnoremap <silent> 1gD   <cmd>lua vim.lsp.buf.type_definition()<CR>\n\t\tnnoremap <silent> gr    <cmd>lua vim.lsp.buf.references()<CR>\n\t\tnnoremap <silent> g0    <cmd>lua vim.lsp.buf.document_symbol()<CR>\n\t\tnnoremap <silent> gW    <cmd>lua vim.lsp.buf.workspace_symbol()<CR>\n\t\tnnoremap <silent> gd    <cmd>lua vim.lsp.buf.declaration()<CR>\n\t\bcmd\bvim\14on_attach\1\0\0\nsetup\vipairs\1\6\0\0\vclangd\18rust_analyzer\fpyright\rtsserver\vsvelte\14lspconfig+<cmd>lua vim.lsp.buf.code_action()<CR>\15<leader>ga\6n\bmap\fp/utils\frequire\0", "config", "nvim-lspconfig")
...
try_loadstring("\27LJ\2\n\v\0\0\1\0\0\0\1K\0\1\0\0", "config", "vim-airline")
